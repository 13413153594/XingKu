...
(function (window, document, Math) {
    ...
    Picker.prototype = {
        ...
        FillData: function () {
            ...
            var title = self.options.title ? self.options.title : '选择地区';
            ...
            var picker_list = '<div class="zx_select showPicker">' +
                '<header>' +
                '<h1>' + title + '</h1><i class="iconfont icon-gou1 nav_right picker-ok"></i></header>' +
            ...
            setTimeout(function () {
                document.querySelector('.zx_select').style.height = '260px';
            }, 0);
        },
