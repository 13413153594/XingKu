        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn lcalendar_cancel">选择日期</div>' +
                    '<div class="date_btn lcalendar_finish"><i class="iconfont icon-gou1"></i></div>' +
                    '</div>' +
            ...
            function finishMobileDate(e) {
                ...
                $("#birthday").html((date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd);
